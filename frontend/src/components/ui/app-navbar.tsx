...
export const AppNavbar: React.FC<NavbarProps> = ({
  ...
  return (
    <a
      style={{
        backgroundColor: isActive ? "#0D00FF" : "#FFFFFF",
        transition: "background-color 0.5s",
      }}
      className={
        isActive
          ? "flex gap-2 text-white px-10 py-3 shadow-[4px_4px_15px_rgba(0,0,0,0.3)] shadow-inner-[inset_4px_4px_15px_rgba(1,1,1,0.3)] w-fit rounded-4xl items-center"
